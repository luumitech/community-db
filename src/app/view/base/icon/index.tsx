...
const supportedIcon = {
  ...
  'person-edit': 'material-symbols:person-edit-outline',
  more: 'mdi:more-vert',
  search: 'akar-icons:search',
  share: 'lucide:share',
  access: 'hugeicons:access',
  ...
  noWarning: 'material-symbols:warning-off-outline-rounded',
  refresh: 'mdi:refresh',
