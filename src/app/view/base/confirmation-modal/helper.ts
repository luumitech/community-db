 ...
 * The confirmation modal is installed once in the app, and
 * this hook is used by the AppContext to control its behavior
 */
export function useConfirmationModal() {
  ...
  return {
     ...
     * can optionally pass in additional arguments
